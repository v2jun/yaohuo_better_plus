...
- 1.8.2
  - 【修复】新版回帖，复读机+1按钮也被复制
  - 【优化】添加函数重试，用于处理元素检测失败的情况，修复部分脚本在元素加载完成前执行的问题
  - 【新增】信箱增强及相关设置项
- 1.8.3
  - 【优化】图片选择上限调整为20张(方便我分享小姐姐)
  - 【优化】修改柯艺云图片上传api，原api已被作者放弃维护，替换为新api
  - 【优化】图片上传逻辑，尽量避免图片顺序错乱(也还是避免不了顺序乱，除非一张一张选择，要不然浏览器获取到的顺序都是由系统决定的)
  - 【修复】发帖 ubb/表情 无法显示问题
-1.8.4
  -【修复】发帖/修改帖子 ubb/表情 重复显示问题(每次老C都要搞些稀奇古怪的更新)
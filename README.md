...
- 1.6.2
  ...
  - 【优化】评论区自动加载更多图片缩放逻辑
- 1.7.0
  - 【新增】抖音，快手，TikTok 视频/图集/直播解析(感谢 @by柯乐/47896 提供的api)
...
- 1.7.2
  ...
  -【优化】发帖/回帖图片上传逻辑，不在批量上传，逐张上传，避免由于接口出问题导致一直卡上传等待。顺带解决了批量上传图片时，返回url顺序错乱的问题。修改了ubb的插入国产，每一张图片现在都是单独的一行了，免得一大堆看起来不清楚
